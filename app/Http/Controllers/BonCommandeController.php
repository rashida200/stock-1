...
//         'reference_produit' => 'required|array|min:1', // Assure que references est un tableau non vide
//         'reference_produit.*' => 'required|exists:produits,reference', // Vérifie chaque référence
//         'quantite' => 'required|array|min:1', // Assure que quantites est un tableau non vide
//         'quantite.*' => 'required|numeric|min:1', // Vérifie chaque quantité
