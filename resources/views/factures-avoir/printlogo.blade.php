...
<body>
    ...
    <div class="company-logo">
        <img src="{{ Storage::url('images/logo.png') }}" alt="Logo" style="height: 50px;">
    </div>
...
<body>
            ...
            <img src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('images/logo.png'))) }}" alt="Logo" style="height: 90px; margin-top: -20px;">
    ...
    <div class="clearfix">
        ...
        <div class="signature-section" style="margin-top: 480px;">
